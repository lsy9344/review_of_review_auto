...
from app.domain.prompts import build_reply_prompt, clean_reply_text, DEFAULT_TONE, DEFAULT_BUSINESS_TYPE
        ...
        for i, review in enumerate(reviews, 1):
            ...
            try:
                if not review_text.strip():
                    ...
                    results.append(ReviewReplyPair(
                        review_id=review_id,
                        review_text="",
                        error="리뷰 텍스트 없음"
                    ))
                ...
                emit("SUCCESS", f"리뷰 '{review_id}' 답변 생성 완료: {generated_reply[:50]}...")
