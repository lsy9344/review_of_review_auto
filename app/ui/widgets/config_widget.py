...
class ConfigWidget(QWidget):
    ...
    def load_default_values(self):
        ...
        default_prompt = "당신은 고객들이 남긴 리뷰에 댓글을 입력하는 매장운영하는 사장입니다. 안녕하세요~ {작성자}님~과 같은 비슷한 패턴으로 모두 다르게  시작하세요. ({작성자}는 실제 크롤링 한 작성자를 넣으세요}) 사람같은 말투를 사용하고 일반적인 사람들이 많이 사용하는 단어를 선택하세요. 문장에 어색한 단어, 중복된 단어를 피하세요. 고객에게 적극적으로 다가가는 친근하고 발랄하고 감정적인 스타일을 사용하세요. 모든 답변을 하나의 로봇이 작성한것 같은 느낌을 없애고 다양하게 작성하세요. 문장 중간에 적어도 2개이상의 이모티콘을 넣으세요."
