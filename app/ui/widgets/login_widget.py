...
class LoginWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.status_detail = QLabel("네이버 계정 정보를 입력하고 로그인 테스트를 진행하세요.")
        ...
        # 초기 스타일 설정
        self.set_status("ready", "로그인 필요", "네이버 계정 정보를 입력하고 로그인 테스트를 진행하세요.")
    ...
    def on_test_login(self):
        ...
        if not user_id or not password:
            self.set_status("error", "입력 오류", "아이디와 비밀번호를 모두 입력해주세요.")
            return
        
        self.set_status("testing", "로그인 테스트 중...", "네이버에 로그인을 시도하고 있습니다.")
